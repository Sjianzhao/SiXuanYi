...
//#define MPU6050_GYRO_OUT        0x3b     //MPU6050加速度数据寄存器地址
//#define MPU6050_ACC_OUT         0x43     //MPU6050陀螺仪数据寄存器地址
#define MPU6050_GYRO_OUT        0x43     //MPU6050加速度数据寄存器地址
#define MPU6050_ACC_OUT         0x3B     //MPU6050陀螺仪数据寄存器地址  //数据手册内容

#define MPU9250_MAG_OUT		      0x03     //MAG_XOUT_L    MPU9250地磁场数据寄存器地址    //////////////////

#define MPU6050_SLAVE_ADDRESS   0xd0      //MPU6050器件读地址

#define MPU9250_SLAVE_ADDRESS	  0x18      //MAG_ADDRESS
...
//#define	MPU9250_RA_PWR_MGMT_1		0x6B	//电源管理，典型值：0x00(正常启用)
#define	MPU9250_RA_WHO_AM_I		  0x75	//IIC地址寄存器(默认数值0x68，只读)


//****************************

#define	MPU9250_GYRO_ADDRESS   0xD0	  //陀螺地址
#define MPU9250_MAG_ADDRESS    0x18   //磁场地址
#define MPU9250_ACCEL_ADDRESS  0xD0 	//加速度地址
